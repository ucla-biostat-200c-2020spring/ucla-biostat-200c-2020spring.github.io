...
Run a logistic regression, using variables `state` to `percent_rural` as predictors. 
...
Perform an analysis of deviance to evaluate the fitted model against the model with just intercept. 

### Q2.7

Perform an analysis of deviance to evaluate the significance of each predictor. Diplay the 10 most significant predictors.
